...
public class ItemRegistry {
    ...
    //Tools, Weapons & Armor
            ...
            arcanium_saber = registerItem("arcanium_saber", () -> new ItemModSword(ToolStats.ARCANIUM_SABER).setAttackArcanaConsumption(250)),
            arcanite_blade = registerItem("arcanite_blade", () -> new ItemModSword(ToolStats.ARCANITE_BLADE).setAttackArcanaConsumption(300)),
    ...
    bedrock_helmet = registerItem("bedrock_helmet", () -> new ItemDivineArmor(ArmorStats.BEDROCK, ArmorItem.Type.HELMET, ArmorInfo.bedrockInfo, new Properties().fireResistant(), MobEffects.FIRE_RESISTANCE, MobEffects.NIGHT_VISION, EXPLOSION_PROTECTION.get())),
