...
public enum ArmorStats implements ArmorMaterial {
    ...
    JACK_O_MAN(2, 5, 3, 1, 0, 0, 21, 9, ARMOR_EQUIP_GENERIC, Blocks.PUMPKIN.asItem()),
    ...
    KRAKEN(5, 9, 8, 5, 3, 0, 20, 9, ARMOR_EQUIP_TURTLE, ItemRegistry.kraken_skin.get()),
    ...
    BEDROCK(5, 9, 8, 5, 4, .99F, ARMOR_EQUIP_NETHERITE),
    ...
    AWAKENED_HALITE(5, 10, 9, 5, 4.5F, .99F, 51, 26, ARMOR_EQUIP_NETHERITE, ItemRegistry.arcanium.get()),
